...
# ── Paths ────────────────────────────────────────────────────
SFT_MODEL="${REPO_ROOT}/model_hub/Qwen2.5-7B-Instruct/base"
...
GPU_IDS_GEN="4"            # single GPU for vLLM (7B fits in 48GB)
NUM_GPUS=4
...
mkdir -p "$LOG_DIR"
LOG_FILE="${LOG_DIR}/cocraft_span_js_qwen7b.log"
...
log "=================================================="
log " CO-CRAFT Span JS — Qwen2.5-7B — 4×L40S"
...
log "=================================================="
log " CO-CRAFT Span JS — Qwen2.5-7B — training complete"
